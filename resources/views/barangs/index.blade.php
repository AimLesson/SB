                                    ...
                                    <td scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="inline-flex rounded-md shadow-sm">
                                            <a href="{{ route('barangs.show', $barang) }}" aria-current="page"
                                                ...
                                                <div class="inline-flex rounded-md shadow-sm">
                                                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" onclick="setFormAction('{{ route('barangs.entry', $barang) }}', 'Tambah')" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">Tambah</button>
                                                    
                                                    <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" onclick="setFormAction('{{ route('barangs.exit', $barang) }}', 'Ambil')" class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">Ambil</button>
                                                </div>
                                        </div>
                                    </td>
                ...
                <form id="quantity-form" method="POST" class="p-4 md:p-5">
                    ...
                    <div class="grid gap-4 mb-4">
                        <div class="col-span-2">
                            ...
                            <input type="number" name="quantity" id="quantity" min="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                        </div>
                    </div>
                    <div class="flex justify-end">
                        <button type="button" class="text-gray-400 bg-gray-200 hover:bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 rounded-lg text-sm px-5 py-2.5 me-2" data-modal-toggle="crud-modal">Cancel</button>
